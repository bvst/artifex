...
void main() {
  group('Internationalization-Friendly Integration Tests', () {
    ...
    testWidgets(
      'App navigation flow works regardless of language',
    ...
    testWidgets(
      'Photo input buttons work regardless of language',
      (WidgetTester tester) async {
        // Set up to go directly to home
        await SharedPreferences.getInstance()
          .then((prefs) => prefs.setBool('onboarding_complete', true));
    ...
    testWidgets(
      'Onboarding page indicators work regardless of language',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          ProviderScope(
            child: ArtifexApp(
