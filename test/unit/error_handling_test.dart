...
void main() {
  group('Error Handling Tests', () {
    ...
    test('should filter keyboard assertion errors', () {
      ...
      void mockDebugLog(String message, [dynamic error, StackTrace? stackTrace]) {
      ...
      FlutterError.onError = (FlutterErrorDetails details) {
        if (details.exception.toString().contains('HardwareKeyboard._assertEventIsRegular') ||
          ...
          mockDebugLog('Filtered keyboard assertion error: ${details.exception}');
          return;
        }
      };
      ...
      final keyboardError = FlutterErrorDetails(
        exception: Exception('HardwareKeyboard._assertEventIsRegular test error'),
      ...
      expect(loggedMessages.first, contains('Filtered keyboard assertion error'));
    });
    ...
    test('should not filter non-keyboard errors', () {
      ...
      void mockErrorLog(String message, [dynamic error, StackTrace? stackTrace]) {
