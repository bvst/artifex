...
import '../../../photo_capture/domain/entities/photo.dart';
import '../../../photo_capture/presentation/providers/photo_capture_provider.dart';
      ...
      next.when(
        data: (photo) {
          if (photo != null) {
            ...
            // TODO: Navigate to photo transformation screen
          }
        },
